...
DB_CONTAINER_NAME="portfolio-postgres-postgres"
...
docker run --name $DB_CONTAINER_NAME -e POSTGRES_PASSWORD=$DB_PASSWORD -e POSTGRES_DB=t3-postgres -d -p 5432:5432 docker.io/postgres
